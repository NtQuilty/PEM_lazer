...
export const services = [
  {
    ...
    description:
      'Режем с точностью от 0,02мм черныю сталь толщиной до 40мм, нержавейку до 20мм, алюминий до 10мм и другие металлы.',
  ...
  },
  {
    ...
    description:
      'Сделаем раскладку, быстро расчитаем стоимость изготовления, дадим реальные сроки. Бережно относимся к материалам заказчика, гарантируем высокое качество деталей.',
