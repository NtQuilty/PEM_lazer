    ...
    <div className='relative mx-auto'>
      <div className='px-4 mx-auto md:max-w-[1350px]'>
        ...
        {servicesData.map((service, index) => (
          <div key={service.id} className='relative mb-8 md:mb-[50px]'>
            <div
            ...
            >
              {index % 2 === 0 ? (
                <>
                  <div className='w-full md:w-1/2 relative flex items-center justify-center md:justify-start z-10 order-2 md:order-1'>
                    <img
                      src={service.image}
                      alt={service.title}
                      className='w-auto h-auto max-h-[300px] md:max-h-[560px] object-contain'
                    />
                  </div>
                  <div className='w-full md:w-1/2 p-4 md:p-6 md:pr-[150px] z-10 order-1 md:order-2'>
                ...
                <>
                  <div className='w-full md:w-1/2 p-4 md:p-6 md:pl-[150px] z-10 order-1'>
                    <h3 className='text-[#d6d6d6] text-2xl md:text-[36px] font-bold mb-3 md:mb-4'>
                      {service.title}
                    </h3>
                    <p className='text-[rgba(214,214,214,0.7)] text-sm md:text-[16px] leading-tight md:leading-[24px] mb-4 md:mb-6'>
                  ...
                  <div className='w-full md:w-1/2 relative flex items-center justify-center md:justify-end z-10 order-2'>
                    <img
                      src={service.image}
                      alt={service.title}
                      className='w-auto h-auto max-h-[300px] md:max-h-[560px] object-contain'
